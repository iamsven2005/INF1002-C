...
- **Input:** `UPDATE ID=2401234 Programme=Applied AI`
- **Expected Output:** `The record with ID=2401234 is successfully updated.`
- **Validation:** Michelle Lee's programme changes from "Information Security" to "Applied AI"
- **Status:** ✓ PASS

#### Test 1.11: SHOW ALL After Updates
- **Input:** `SHOW ALL`
- **Expected Output:** 4 records with Michelle Lee showing Updated values (Mark=69.8, Programme=Applied AI)
...
| Test | Message | Status |
|------|---------|--------|
| 4.1 | `The database file "Group9_CMS.txt" is successfully opened.` | ✓ |
| 4.2 | `Here are all the records found in the table "StudentRecords".` | ✓ |
| 4.3 | `The record with ID=2301234 already exists.` | ✓ |
| 4.4 | `A new record with ID=2401234 is successfully inserted.` | ✓ |
| 4.5 | `The record with ID=2501234 does not exist.` | ✓ |
| 4.6 | `The record with ID=2401234 is found in the data table.` | ✓ |
| 4.7 | `The record with ID=2401234 is successfully updated.` | ✓ |
| 4.8 | `The deletion is cancelled.` | ✓ |
| 4.9 | `The record with ID=2301234 is successfully deleted.` | ✓ |
...
|---|------|----------|--------|
| 1 | Open file and read 3 records | `open_and_read_file()` | ✓ |
| 2 | Find existing record by ID | `find_record_index()` | ✓ |
| 3 | Find nonexistent record returns -1 | `find_record_index()` | ✓ |
| 4 | Validate valid ID string | `isValidID()` | ✓ |
| 5 | Reject invalid ID string | `isValidID()` | ✓ |
| 6 | Validate valid mark value | `isValidMarks()` | ✓ |
| 7 | Reject invalid mark value | `isValidMarks()` | ✓ |
| 8 | Parse mark value correctly | `isValidMarks()` | ✓ |
| 9 | Validate valid name | `isValidName()` | ✓ |
| 10 | Reject name with numbers | `isValidName()` | ✓ |
| 11 | Case-insensitive string comparison (equal) | `strcasecmp_ci()` | ✓ |
| 12 | Case-insensitive string comparison (different) | `strcasecmp_ci()` | ✓ |
| 13 | Extract ID value from input | `find_id_value()` | ✓ |
| 14 | Extract ID value (lowercase) | `find_id_value()` | ✓ |
| 15 | Handle missing ID value | `find_id_value()` | ✓ |
| 16 | Save records to file | `save()` | ✓ |
| 17 | Handle empty record list | `find_record_index()` | ✓ |
| 18 | Find first occurrence of duplicate ID | `find_record_index()` | ✓ |
| 19 | Validate boundary ID (0) | `isValidID()` | ✓ |
| 20 | Validate large ID | `isValidID()` | ✓ |
